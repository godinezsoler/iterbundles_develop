...
<%
final String HIDE_CONTROL_PANEL_OPTION 	= "iter.hide.controlpanel.journal.%s";
final String TAB_TEMPLATES 				= "templates";	
final String TAB_WEB_CONTENT 			= "web-content";
final String TAB_STRUCTURES				= "structures";
final String TAB_FEEDS					= "feeds";
final String TAB_RECENT					= "recent";
		 
boolean showTemplates 	= !HotConfigUtil.getKey(String.format(HIDE_CONTROL_PANEL_OPTION, TAB_TEMPLATES), 	false);
boolean showWeb_content = !HotConfigUtil.getKey(String.format(HIDE_CONTROL_PANEL_OPTION, TAB_WEB_CONTENT), 	true);
boolean showStructures	= !HotConfigUtil.getKey(String.format(HIDE_CONTROL_PANEL_OPTION, TAB_STRUCTURES), 	true);
boolean showFeeds		= !HotConfigUtil.getKey(String.format(HIDE_CONTROL_PANEL_OPTION, TAB_FEEDS), 		true);
boolean showRecent		= !HotConfigUtil.getKey(String.format(HIDE_CONTROL_PANEL_OPTION, TAB_RECENT), 		true);

String defaultTab = "";
if (showTemplates)
	defaultTab = TAB_TEMPLATES;
else if (showWeb_content)
	defaultTab = TAB_WEB_CONTENT;
else if (showStructures)
	defaultTab = TAB_STRUCTURES;
else if (showFeeds)
	defaultTab = TAB_FEEDS;
else if (showRecent)
	defaultTab = TAB_RECENT;
...
if (showTemplates)
	tabNames.add(TAB_TEMPLATES);
if (showWeb_content)
	tabNames.add(TAB_WEB_CONTENT);
if (showStructures)
	tabNames.add(TAB_STRUCTURES);
if (showFeeds)
	tabNames.add(TAB_FEEDS);
if (showRecent)
	tabNames.add(TAB_RECENT);
%>
