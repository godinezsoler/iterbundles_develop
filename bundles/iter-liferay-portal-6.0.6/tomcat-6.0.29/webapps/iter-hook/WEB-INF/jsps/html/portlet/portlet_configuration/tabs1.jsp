...
String PORTLET_FULL_CONFIGURATION = "portlet.full.configuration";
...
String full = PortalUtil.getPortalProperties().getProperty(PORTLET_FULL_CONFIGURATION);
boolean fullConfiguration = false;
